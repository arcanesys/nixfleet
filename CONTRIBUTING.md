...
See [Test harness](docs/reference/harness.md) for tier details and how to drill into specific failures.
...
Significant design rationale lives in [`docs/design/architecture.md`](docs/design/architecture.md) (mechanism + invariants) and `docs/rfcs/` (forward-looking design proposals). Read those before proposing changes to core patterns like `mkHost`, hostSpec, or the agent state machine.
